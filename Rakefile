...
namespace :static do
  ...
  task :generate do
    ...
    Dir.chdir 'public' do
      ...
      `wget -mnH http://localhost:3000/.well-known/acme-challenge/R3dBz6-qATFpoFD8g6pKpo9WYjMY_bnbGfw73YuqTNI`
      `wget -mnH http://localhost:3000/.well-known/acme-challenge/T4iJRKmsEQMJ3RKrvvGsRrUfaTTb_1S_WTH457A07fw`
    end
    `rsync -ruv public/`
  end
